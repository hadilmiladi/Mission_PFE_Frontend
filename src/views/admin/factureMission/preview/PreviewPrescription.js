        ...
        <div className="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
          ...
          <div className="mt-md-0 mt-2">
            <h4 className="invoice-title">
              Invoice <span className="invoice-number">#{data.item?.id}</span>
            </h4>
            <div className="invoice-date-wrapper">
              <p className="invoice-date-title">Date Issued:</p>
              <p className="invoice-date">{data?.item?.from}</p>
            </div>
            <div className="invoice-date-wrapper">
              <p className="invoice-date-title">Due Date:</p>
              <p className="invoice-date">{data?.item?.to}</p>
            </div>
          </div>
        </div>
        {/* /Header */}
...
{/* 
      ...
      <Table responsive>
        ...
        <tbody>
          <tr>
            <td className="py-1">
              <p className="card-text fw-bold mb-25">Plane pricing</p>
            ...
            <td className="py-1">
              <span className="fw-bold">{data?.item?.mission?.planePrice} $</span>
            </td>
          </tr>
          <tr className="border-bottom">
            <td className="py-1">
              <p className="card-text fw-bold mb-25">Hotel pricing</p>
            </td>
            <td className="py-1">
              <span className="fw-bold"></span>
            </td>
            ...
            <div className="invoice-total-wrapper">
              <div className="invoice-total-item">
                ...
                <p className="invoice-total-amount">
                  {data?.item?.mission?.planePrice+data?.item?.mission?.planePrice} $
                </p>
              </div>
              <div className="invoice-total-item">
                <p className="invoice-total-title">Prediem:</p>
                <p className="invoice-total-amount">
                  {data?.prxdium?.perdiem} $
                </p>
              </div>
              <div className="invoice-total-item">
                <p className="invoice-total-title">Discount:</p>
                <p className="invoice-total-amount">0</p>
              </div>
              <div className="invoice-total-item">
